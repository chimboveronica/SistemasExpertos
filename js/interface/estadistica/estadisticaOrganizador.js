...
Ext.onReady(function () {
    ...
    storeCountAccessByUser = Ext.create('Ext.data.Store', {
        ...
        proxy: {
            type: 'ajax',
            url: 'php/interface/estadistica/getCountAccessByUser.php',
            reader: {
                type: 'json',
                root: 'data'
            }
    ...
    storeCountExcesosVelocidad = Ext.create('Ext.data.Store', {
        ...
        proxy: {
            type: 'ajax',
            url: 'php/interface/estadistica/getCountExcesosVelocidad.php',
            reader: {
                type: 'json',
                root: 'data'
            }
    ...
    storeCountByDevice = Ext.create('Ext.data.Store', {
        ...
        proxy: {
            type: 'ajax',
            url: 'php/interface/estadistica/getCountByDevice.php',
            reader: {
                type: 'json',
                root: 'data'
            }
    ...
    storeCountTypeByDevice = Ext.create('Ext.data.Store', {
        proxy: {
            type: 'ajax',
            url: 'php/interface/estadistica/getCountTypeByDevice.php',
            reader: {
                type: 'json',
                root: 'data'
            }
